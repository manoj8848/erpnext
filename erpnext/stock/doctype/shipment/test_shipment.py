...
from frappe.utils import flt, get_time,now, add_to_date
...
class TestShipment(FrappeTestCase):
	...
	def test_whitelisted_methods_TC_SCK_357(self):
		from erpnext.stock.doctype.shipment.shipment import get_address_name,get_contact_name,get_company_contact
		company = "_Test Indian Registered Company"
		if not frappe.db.exists("Company", company):
			make_company(company)
		args1 = {
