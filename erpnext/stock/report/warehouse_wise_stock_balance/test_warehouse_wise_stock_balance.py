...
class TestWarehouseStockBalanceReport(FrappeTestCase):
    ...
    def setUp(self):
        ...
        # Create stock entries (which will create SLEs)
        make_stock_entry(
    ...
    def test_aggregation_of_stock_balance(self):
    ...
    def test_show_disabled_warehouses(self):
    ...
    def test_balance_propagation_to_parent(self):
        filters = _dict(company=self.company)
        _, data = warehouse_wise_stock_balance.execute(filters)
