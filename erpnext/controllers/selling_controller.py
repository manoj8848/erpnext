...
from erpnext.controllers.accounts_controller import get_taxes_and_charges, InvalidQtyError
...
class SellingController(StockController):
	...
	def get_item_list(self):
		...
		for d in self.get("items"):
			if d.qty is None:
				message = _("Row {0}: Qty is mandatory").format(d.idx)Add commentMore actions
